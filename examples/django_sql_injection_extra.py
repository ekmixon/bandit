...
User.objects.filter(username='admin').extra(select={'test': 'nosecure'})
User.objects.filter(username='admin').extra(select={'test': 'nossecure'})
...
User.objects.filter(username='admin').extra(where=['nosecure'])
User.objects.filter(username='admin').extra(where=['nosecure'])
